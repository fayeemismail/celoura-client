...
import { getDestinationByIdThunk, updateDestinationThunk } from "../../redux/admin/authThunks";
...
export default function EditDestination() {
        ...
        const fetchDestination = async () => {
            ...
            try {
                ...
                const fetchedData = {
                    ...
                    photos: [...photos, null, null, null, null].slice(0, 4),
                };
    ...
    const validateForm = (): boolean => {
        ...
        // Additional restrictions for country and features
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        const features = formData.featureInput.split(",").map(f => f.trim()).filter(Boolean);
        ...
        formData.photos.forEach((photo) => {
            if (photo instanceof File) {
                ...
                formPayload.append("existingPhotos", photo);
            }
        });

        try {
            await dispatch(updateDestinationThunk( id!, formPayload ))
                    ...
                    <div className="bg-[#242A38] p-6 rounded shadow">
                        ...
                        <form onSubmit={handleSubmit} className="space-y-4">
                            ...
                            <button
                                ...
                                className={`px-4 py-2 rounded transition ${!isFormChanged() || loading
